...
(function( $ ) {
	...
	(function() {
		...
		menuToggle.on( 'click.gt_next', function() {
	...
	(function() {
		...
		function toggleFocusClassTouchScreen() {
			if ( 'none' === $( '.menu-toggle' ).css( 'display' ) ) {
				...
				$( document.body ).on( 'touchstart.gt_next', function( e ) {
				...
				siteNavigation.find( '.menu-item-has-children > a, .page_item_has_children > a' )
					.on( 'touchstart.gt_next', function( e ) {
				...
				siteNavigation.find( '.menu-item-has-children > a, .page_item_has_children > a' ).unbind( 'touchstart.gt_next' );
			}
		}

		if ( 'ontouchstart' in window ) {
			$( window ).on( 'resize.gt_next', toggleFocusClassTouchScreen );
			toggleFocusClassTouchScreen();
		}

		siteNavigation.find( 'a' ).on( 'focus.gt_next blur.gt_next', function() {
