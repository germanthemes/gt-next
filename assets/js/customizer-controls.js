...
( function( wp, $ ) {
	...
	wp.customize( 'custom_logo', function( setting ) {
		setting.bind( function( value ) { 
			if ( '' !== value ) {
				...
				wp.customize.instance( 'gt_next_theme_options[retina_logo]' ).set( false );
			}
		});
		...
		wp.customize.control( 'gt_next_theme_options[retina_logo_title]', setupControl );
		wp.customize.control( 'gt_next_theme_options[retina_logo]', setupControl );
	} );
	 ...
	 */
	wp.customize.controlConstructor.gt_next_custom_font = wp.customize.Control.extend({
		/**
