...
* @return mixed
*/
function gt_next_get_option( $option_name = '' ) {
 ...
 * @return array
 */
function gt_next_theme_options() {

	// Merge theme options array from database with default options array.
	$theme_options = wp_parse_args( get_option( 'gt_next_theme_options', array() ), gt_next_default_options() );

	// Return theme options.
	return apply_filters( 'gt_next_theme_options', $theme_options );
}
 ...
 * @return array
 */
function gt_next_default_options() {
	...
	return apply_filters( 'gt_next_default_options', $default_options );
}
