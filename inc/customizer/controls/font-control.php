...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class GT_Next_Customize_Font_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'gt_next_custom_font';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'gt-next' ),
				'next'     => esc_html__( 'Next Font', 'gt-next' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'gt-next' ),
			);

			// Set Fonts.
			$this->fonts = GT_Next_Custom_Fonts::get_available_fonts();
